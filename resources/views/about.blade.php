        ...
        <section id="profile">
            ...
            <div class="profile-container">
                <div class="me-icon-container">
                    <img class="me-icon" src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}"
                ...
                @foreach ($educations as $education)
                    <div class="education-experience-card">
                        <div class="card-info">
                            ...
                            <p class="text-black">{{ $education->education_location }}</p>
                        </div>
                        <div class="card-description">
                            <h5>Achievements</h5>
                            @php
                                $achievementss = explode(',', $education->achievements);
                            @endphp
                            @foreach ($achievementss as $achievement)
                                <p>{{ $achievement }}</p>
                            @endforeach
                        </div>
                    </div>
                ...
                @foreach ($experiences as $experience)
                    <div class="education-experience-card">
                        <div class="card-info">
                            ...
                            <p class="date">{{ $experience->start }} - {{ $experience->end }}</p>
                            <p><a href="{{ $experience->company_url }}">{{ $experience->company_name }}</a><br>
                                {{ $experience->nature_work }}</p>
                        </div>
                        <div class="card-description">
